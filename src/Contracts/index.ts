...
export type EventListeners = string | Array<string> | Function
...
export type ExceptionHandler = (error: any, ctx: Http.Context) => void
...
export type moveCallback = (file: File, index: number) => MoveOptions
 ...
 * @constructor
 */
export declare interface FileJar {
...
export declare namespace Http {
  ...
  interface Request extends Macroable {
    ...
    * @return
    */
    collect(keys : Array<string>): Array<object>
    ...
    * @return
    */
    except(keys : Array<string>): Object
    ...
    * @return
    */
    ips(trust? : boolean): Array<string>
    ...
    * @return
    */
    subdomains(trust? : boolean, offset? : number): Array<string>
    ...
    * @return
    */
    accepts(types? : Array<string>): string | Array<string>
    ...
    * @return
    */
    language(acceptedLanguages? : Array<string>): string
    ...
    * @return
    */
    encoding(acceptedEncodings? : Array<string>): string
    ...
    * @return
    */
    charset(acceptedCharsets : Array<string>): string
    ...
    * @return
    */
    match(routes : Array<string>): boolean
...
export type Auth = Auth.ApiScheme & Auth.BasicAuthScheme & Auth.JwtScheme & Auth.SessionScheme
...
/**
  ...
  * ```
  */
export interface Route extends Macroable {
  verbs: Array<string>
  handler: Function | string
  name: string
  forDomain: RegExp
  middlewareList: Array<string>
  domainKeys: Array<object>
  ...
  /**
    ...
    * @param verbs
    */
  new (route : string, handler : string | Function, verbs : Array<string>): Route
  ...
  /**
    ...
    * @return
    */
  formats(formats : Array<string>, strict? : false): Route
  ...
  /**
    ...
    * @return
    */
  middleware(...middleware : Array<Function>): Route
  middleware(middleware : string | Array<string>): Route
  ...
  /**
    ...
    * @return
    */
  prependMiddleware(...middleware : Array<Function>): Route
  prependMiddleware(middleware : string | Array<string>): Route
  ...
  /**
    ...
    * @return
    */
  resolve(url: string, verb: 'string', host?: string): {
    url: string,
    params: Array<string>,
    subdomains: {}
  } | null
...
export declare namespace Route {
  ...
  class Brisk {
    ...
    * @return
    */
    setHandler(handler: Function | string, verbs: Array<string>): Route
  ...
  class Group {
    ...
    * @return
    */
    middleware(middleware: string | Array<string>): Group
    middleware(...middleware: Array<Function>): Group
    ...
    * @return
    */
    formats(formats: Array<string>, strict: false): Group
  ...
  class Resource {
    ...
    * @return
    */
    only(names: Array<string>): Resource
    ...
    * @return
    */
    except(names: Array<string>): Resource
    ...
    * @return
    */
    middleware(middleware: string | Array<string>): Resource
    middleware(middleware: Map<Array<string>, string>): Resource
    ...
    * @param strict?
    */
    formats(formats: Array<string>, strict: false): Resource
    ...
    */
     ...
     * route resource
     */
    validator(validatorsMap: Map<Array<string>, Array<string>>): Resource
  }
  ...
  class Manager {
    ...
    * @return
    */
    route(route: string, handler: string | Http.Handler, verbs: Array<string>): Route
    ...
    * @return
    */
    match(url: string, verb: string, host?: string): MatchedRoute | null
...
export type HttpServer = any // node Server instance
...
export interface Server {
  ...
  /**
    ...
    * @return
    */
  registerGlobal(middleware : Array<string>): Server
  ...
  /**
    ...
    * @return
    */
  use(middleware : Array<string>): Server
  ...
  /**
    ...
    * @return
    */
  registerNamed(middleware : Array<string> | Object): Server
...
export declare namespace View {
  ...
  interface Template {
    ...
    * @return
    */
    newContext(...props : Array<object>): Template
...
/**
  ...
  * @group Database
  */
export interface Database extends DatabaseManager, Database.Builder {
  /**
...
export declare namespace Database {
  ...
  type AggragationResult = Promise<Array<object>[]>
  type NumberResult = Promise<number>
  type NumberResults = Promise<Array<number>>

  type Callback = Function
  type Client = Function
  type Value = string | number | boolean | Date | Array<string> | Array<number> | Array<Date> | Array<boolean> | Raw
  ...
  interface QueryInterface {
    ...
    insert(data: any, returning?: string | Array<string>): QueryInterface
    modify(callback: QueryCallbackWithArgs, ...args: any[]): QueryInterface
    update(data: any, returning?: string | Array<string>): QueryInterface
    update(columnName: string, value: Value, returning?: string | Array<string>): QueryInterface
    returning(column: string | Array<string>): QueryInterface

    del(returning?: string | Array<string>): QueryInterface
    delete(returning?: string | Array<string>): QueryInterface
  ...
  interface TableBuilder {
    ...
    dropColumns(...columnNames: Array<string>): TableBuilder
    ...
    primary(columnNames: Array<string>): TableBuilder
    ...
    dropForeign(columnNames: Array<string>, foreignKeyName?: string): TableBuilder
  ...
  interface MultikeyForeignConstraintBuilder {
    references(columnNames: Array<string>): ReferencingColumnBuilder
  }
...
export declare namespace Ignitor {
  type callback = () => void
  type validHooks = {
    [key in
      'providersRegistered' |
...
export declare namespace Lucid {
  /**
...
export type RedisFactory = Redis.RedisFactory & ioredis.Redis
export type Redis = Redis.Core & RedisFactory
...
export interface Drive {
  ...
  /**
    ...
    * @return
    */
  get(location : string, encoding? : string | object): Promise<string>
  ...
  /**
    ...
    * @return
    */
  put(location : string, content : string | stream, options? : Object): Promise<Boolean>
  ...
  /**
    ...
    * @return
    */
  prepend(location : string, content : string, options? : Object): Promise<boolean>
  ...
  /**
    ...
    * @return
    */
  append(location : string, content : string | stream, options? : object): Promise<boolean>
...
export declare namespace AdonisNamespaces {
